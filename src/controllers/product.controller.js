...
exports.addRecord = async(req, res) => {
    let {content, lat, lng} = req.body;
    // let currTime = new Date().toISOString();
    console.log('INSERT INTO "tblRecord"(content, lat, lng) VALUES ($1, $2, $3)',
        [content, lat, lng]);
    let {recordRows} = await db.query(
        'INSERT INTO "tblRecord"(content, lat, lng) VALUES ($1, $2, $3)',
        [content, lat, lng]
    )
